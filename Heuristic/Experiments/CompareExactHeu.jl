...
excel_file     = joinpath(@__DIR__, "..", "..", "inputData", "Experiments/inputDataEx2_1_1.xlsx")
...
for i in 1:LoopIter
    (obj_vals[i], best_sol, iter_vals[i], ttg_vals[i], tto_vals[i]) =
        HeuristicSA(maxTurnaround, Maxtime, data, rt, top_c)
end
